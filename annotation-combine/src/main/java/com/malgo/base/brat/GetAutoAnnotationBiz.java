package com.malgo.base.brat;

import com.malgo.base.BaseBiz;
...
public class GetAutoAnnotationBiz extends BaseBiz<Integer,String> {
  ...
  @Override
  protected void authorize(String authToken, Integer integer) throws BusinessRuleException {

  }

  @Override
  protected String doBiz(Integer integer) {
    List<AutoAnnotation>  autoAnnotationList=algorithmApiService.listAutoAnnotationThroughAlgorithm(integer);
