...
public class PermissionConstant {
  ...
  public static final String ANNOTATION_BLOCK_IMPORT = "annotation:block:import"; // 新增语料
  ...
  public static final String ANNOTATION_TASK_DETAIL = "annotation:task:detail"; // 单条标注
