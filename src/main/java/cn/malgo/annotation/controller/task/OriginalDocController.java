...
public class OriginalDocController {
  ...
  public Response<List<OriginalDoc>> importDocs(@RequestBody ImportDocRequest request) {
    ...
    return new Response<>(importDocBiz.process(request));
  }
  ...
  public Response<CreateBlocksFromDocVO> createBlocks(
    ...
    return new Response<>(createBlocksFromDocBiz.process(request));
  }
  ...
  public Response<PageVO<OriginalDoc>> listOriginalDoc(ListDocRequest listDocRequest) {
    return new Response<>(listOriginalDocBiz.process(listDocRequest));
  }
}
