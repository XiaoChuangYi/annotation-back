...
public class AnnotationTaskController {
  ...
  public Response<AnnotationTaskVO> create(@RequestBody CreateTaskRequest request) {
    return new Response<>(createTaskBiz.process(request));
  }
  ...
  public Response addBlocksToTask(@RequestBody AddBlocksToTaskRequest addBlocksToTaskRequest) {
    return new Response<>(addBlocksToTaskBiz.process(addBlocksToTaskRequest));
  }
  ...
  public Response<PageVO<AnnotationTaskVO>> listAnnotationTask(ListAnnotationTaskRequest request) {
    return new Response<>(listAnnotationTaskBiz.process(request));
  }
  ...
  public Response<AnnotationTaskDetailVO> listTaskDetails(@PathVariable("id") long id) {

    return new Response<>(listTaskDetailsBiz.process(new ListTaskDetailRequest(id)));
  }
  ...
  public Response<PageVO<AnnotationTaskBlockResponse>> listAnnotationTaskBlock(
    ...
    return new Response<>(listAnnotationTaskBlockBiz.process(listAnnotationTaskBlockRequest));
  }
  ...
  public Response terminateTask(@RequestBody TerminateTaskRequest terminateTaskRequest) {
    return new Response<>(terminateTaskBiz.process(terminateTaskRequest));
  }
  ...
  public Response<List<AnnotationTaskBlockResponse>> getUnCoveredBlocks(
    ...
    return new Response<>(getUnCoveredBlockBiz.process(getUnCoveredBlockRequest));
  }
  ...
  public Response<AnnotationTaskVO> refreshTaskSummary(
    ...
    return new Response<>(refreshTaskSummaryBiz.process(terminateTaskRequest));
  }
  ...
  public Response<TaskInfoVO> getDoingTaskSummary() {
    return new Response<>(getDoingTaskSummaryInfoBiz.process(null));
  }
}
