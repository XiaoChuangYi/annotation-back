...
public class AnnotationTaskController {
  ...
  public Response<PageVO<AnnotationTaskBlockResponse>> listAnnotationTaskBlock(
    ...
    return new Response<>(listAnnotationTaskBlockBiz.process(listAnnotationTaskBlockRequest, null));
  }
  ...
  public Response<TaskInfoVO> getDoingTaskSummary(final HttpServletRequest request) {
