...
public class ExerciseAnnotationServiceImpl implements ExerciseAnnotationService {
  ...
  public Page<AnnotationCombine> listStandardExerciseAnnotation(
    ...
    Page<AnnotationCombine> page = annotationCombineRepository
        .findAll(queryExerciseAnnotationCondition(listExerciseAnnotationRequest), PageRequest
            .of(listExerciseAnnotationRequest.getPageIndex(),
