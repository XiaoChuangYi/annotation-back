...
public class ApiServerClientTest {
    ...
    public  void testRuleTokenizePos(){
        String annotationResult=apiServerClient.ruleTokenizePos("胸椎椎体次全切除钢板内固定术");
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>ApiServer<<<<<<<<<<<<<<<<<<<<<<<<<");
    ...
    public void testBatchTokenizePos(){
        ...
        annotationOriginTextRequest.setText("胸椎椎体次全切除钢板内固定术");
        ...
        annotationOriginTextRequest.setText("腹腔镜下输卵管囊肿切除");
        annotationOriginTextRequestList.add(annotationOriginTextRequest);
    ...
    public void testPhraseUpdatePosWithNewTerm() {
        ...
        String annotationResult=apiServerClient.phraseUpdatePosWithNewTerm(updateAnnotationRequest);
        System.out.println(">>>>>>>>>>>>>>>>>>>>>>>>>>>ApiServer<<<<<<<<<<<<<<<<<<<<<<<<<");
